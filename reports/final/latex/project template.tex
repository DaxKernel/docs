...
floatflt,caption,float,comment,fancyhdr,geometry,subfigure,amssymb,color,
indentfirst,booktabs,array,xspace,nomencl, hyperref, listings, tcolorbox,
}
...
\include{2DesignDiagrams}
\include{3BuildProcess}
\include{VGADisplay}
\include{Interrupts}
\include{Keyboard}
\include{UnitTesting}
